...
// navigates/reloads — a SPA left open for a long time can sit on a stale bundle
// indefinitely otherwise. Poll explicitly so a deploy actually reaches long-lived sessions.
