      ...
      {toasts.map((toast) => (
        ...
        >
          {/* brand-600, not brand-100 — 100 is a fill/tint token, not a text
              ...
              bg-elevated there. brand-600 is the app's actual accent teal and
              stays legible against `elevated` in both themes (same fix
              already applied on operator-app's copy of this component). */}
