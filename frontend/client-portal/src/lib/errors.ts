...
// LoginPage/RegisterPage need the raw code itself (not just its translated
// message) to decide whether to render/keep the Turnstile widget at all —
// getErrorMessage below only ever returns display text.
