...
type Tab = 'notifications' | 'security' | 'telegram' | 'language' | 'design';

// Own-account settings (as opposed to SettingsModal, which is the org-wide
// admin panel) — a smaller version of the same left-nav-tabs shell.
export function MySettingsModal({ onClose }: { onClose: () => void }) {
  ...
  const tabs: { key: Tab; label: string }[] = [
    ...
    { key: 'telegram', label: t('settings.tabTelegram') },
